...
Here the table is not yet tidy because rows further down contain non-numerics in the grade column and all variable names need edited. 
...
## Ask questions to become familiar with the data set
